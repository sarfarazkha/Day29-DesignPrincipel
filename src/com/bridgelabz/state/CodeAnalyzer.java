...
public class CodeAnalyser {
    ...
    public int loadIndiaCodeData(String csvFilePath) throws CodeAnalyserException {
        try {
            ...
            throw new CodeAnalyserException(e.getMessage(), CodeAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM);
        } catch (RuntimeException e) {
            throw new CodeAnalyserException(e.getMessage(),
                    CodeAnalyserException.ExceptionType.INCORRECT_DELIMITER_OR_HEADER);
        }
        return namOfEateries;
    }
}
